...
set @kdnr = (
    ...
    from leist 
    where buchnr = {STATEMENT_EXTRACTOCONTA_WEBSERVICE.ResNumber} 
      and rechnung = {STATEMENT_EXTRACTOCONTA_WEBSERVICE.window}
)
set @tag = '1741174727'
set @mpehotel = 2
    ...
    (
        select 
            ...
            (select 
                ...
                case 
                    when buch.resuser like 'AvailPro%' then 'Imported' 
                    else buch.resuser 
                end as 'UserName',
            ...
            (select 
             ...
             from 
                (select 
                 ...
                 from leist
                 where leist.buchnr = {STATEMENT_EXTRACTOCONTA_WEBSERVICE.ResNumber} 
                   and rechnung = {STATEMENT_EXTRACTOCONTA_WEBSERVICE.window} 
                   and grpref < 0
